...
function Cart() {
  ...
  const listeDuPanier = ['Monstera', 'Lierre', 'Bouquet de fleurs'];
  ...
  return (
    <div style={divCartStyle}>
      <button id="bouttonFermer" style={buttonFermerStyle}>
        Fermer
      </button>
      <br />
      <h1>Panier</h1>
      <ul>
        <li>
          {listeDuPanier[0]} {prixMonstera}€
        </li>
        <li>
          {listeDuPanier[1]} {prixLierre}€
        </li>
        <li>
          {listeDuPanier[2]} {prixBouquet}€
        </li>
      </ul>
      <p>Total : {prixTotal}€</p>
